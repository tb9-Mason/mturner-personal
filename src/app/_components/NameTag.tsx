export const NameTag = () => {
  return (
    <div className="rounded-xl bg-red-800 border-red-800 border-4 text-center -rotate-2 overflow-hidden shadow-2xl transition-transform min-w-full xs:min-w-xs sm:min-w-80 dark:shadow-dark hover:scale-105">
